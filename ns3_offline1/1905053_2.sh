...
do
    ...
    ./ns3 run scratch/1905053_2 -- --nNodes=$nNodes --nFlows=50 --nPacketsPerSecond=500 --speedOfNodes=5 --datFileTrack=1
...
do
    ...
    #value of reset others are fixed
    ./ns3 run scratch/1905053_2 -- --nNodes=20 --nFlows=10 --nPacketsPerSecond=100 --speedOfNodes=$speedOfNodes --datFileTrack=4
