...
public class Server {
    ...
    private Map<String, Socket> connectedClients; //online
    List<ClientHandler> allClientsNow;  //online clients
    Map<String, Socket> disconnectedClients; //offline clients
    public String baseDirectory = "D:\\ServerFiles";
    public String baseDirectoryClientSide = "D:\\ClientFiles";
    public List<String> anyClient; //whoever performs login
